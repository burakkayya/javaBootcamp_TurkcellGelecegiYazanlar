...
public class Messages {
    public static class Car{
        ...
        public static final String PlateNotValid = "PLATE_NUMBER_MUST_MATCH_THE_PATTERN";
    }
    ...
    public static class Maintenance{
        ...
        public static final String CarExists = "CAR_CURRENTLY_UNDER_MAINTENANCE";
        public static final String CarNotExists = "CAR_NOT_REGISTERED_FOR_MAINTENANCE";
        public static final String CarIsRented = "CAR_IS_RENTED_AND_CANNOT_BE_SERVICED";
    }
